System.register([], function(exports_1) {
    "use strict";
    var MeteorMongoTailableCursor;
    return {
        setters:[],
        execute: function() {
            Npm.require('mongodb');
            MeteorMongoTailableCursor = (function () {
                function MeteorMongoTailableCursor(options, getCursorFn) {
                ...
                ;
                MeteorMongoTailableCursor.prototype.connectToMongo = function () {
                    var $self = this;
                ...
                MeteorMongoTailableCursor.prototype.getTimestamp = function (callbackFn) {
                ...
                ;
                MeteorMongoTailableCursor.prototype.startStreaming = function () {
                    console.log("Streaming is ready to start");
                    console.log(this.options);
                    // Crear el cursor tailable.
                };
                return MeteorMongoTailableCursor;
            })();
            exports_1("MeteorMongoTailableCursor", MeteorMongoTailableCursor);
        }
    }
});
